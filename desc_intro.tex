Cavitation and abrasion in hydropower turbines erode the surface of the
...
recoating in short intervals \citep{santa2009slurry}.% Turbine disassembling, recoating and turbine reassembling would be a very expensive process that should not be done regularly.
...
% in the turbine output. The formation of large bubbles modifies the
...
% The liquid has the combination of kinetic components,
