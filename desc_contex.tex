...
Turbine repair or inspection requires water flow stoppage and water drainage.
%In Jirau, there is a 800 mm diameter access (bottom hatch) for rotor maintenance.
In the context of EMMA, the turbine points of interest are: 1) Propeller and
blades; 2) Runner area and adjacent areas; 3) Hatches; 4) Draft tube; and 5)
...
allowing magnetic fixing solutions for robotic systems. However, the cylindrical
...
Runner area and generally used for blade lip inspection.
...
5) Available infrastructure: after the turbine drai\-nage, maintenance provides
